...
def get_latest_post_safe(insta_id, cookie_value):
    ...
    # Instagramにアクセスするときはそのままの名前を使うよ
    ...
    try:
        ...
        # 🌟ココが魔法！Discordアプリが迷子にならないように「_」を「%5F」にすり替える！
        safe_insta_id = insta_id.replace("_", "%5F")
        
        return {
            "id": caption[:50],
            "url": f"https://www.instagram.com/{safe_insta_id}/",
            "caption": caption
        }
